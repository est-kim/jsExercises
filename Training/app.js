...
//EXERCISE: Make a program that filters a list of strings and returns a list with only your friends name in it.
...
// function friend(friends){
//     // let friends = ["Apple", "Two", "Yesterday", "mother", "lol", "car", "computer"];
//     console.log(friends.filter(function(item){
